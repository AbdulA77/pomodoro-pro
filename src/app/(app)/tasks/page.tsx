        ...
        >
          <div className="flex justify-between items-start">
            <div>
              ...
              >
                Manage Your Tasks & Track You Progress.
              </motion.p>
            </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-orange-400">
                      {taskStats.completedPomodoros}/{taskStats.totalPomodoros}
                    </p>
                  </div>
                ...
                <Card className="group relative overflow-hidden bg-white/5 backdrop-blur-sm border-white/10 hover:bg-white/10 transition-all duration-300 hover:scale-[1.02] shadow-xl">
                  <CardContent className="p-6">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      ...
                      {task.dueAt && (
                        <Badge
                          className={`${getDueDateColor(task.dueAt) === "text-red-400" ? "bg-red-500/20 text-red-400 border-red-500/30" : getDueDateColor(task.dueAt) === "text-orange-400" ? "bg-orange-500/20 text-orange-400 border-orange-500/30" : "bg-gray-500/20 text-gray-400 border-gray-500/30"} border`}
                        >
                      ...
                      <div className="mt-4">
                        ...
                        <div className="w-full bg-white/10 rounded-full h-2">
                          <motion.div
                            ...
                            initial={{ width: 0 }}
                            animate={{
                              width: `${Math.min((task.completedPomodoros / task.estimatePomodoros) * 100, 100)}%`,
                            }}
                            transition={{ duration: 0.8, delay: 0.2 }}
                          />
                        </div>
        ...
        >
          <TaskForm
            ...
            trigger={
              <Button
                size="lg"
                className="h-14 w-14 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white shadow-lg hover:shadow-xl transition-all duration-300"
              >
